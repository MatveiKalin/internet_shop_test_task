...
/* 1. Версия 5.
Блок без имени, а в ней курсор, который отдает иерархический список категорий, начиная с тех, в которых есть товары с заведенной стоимостью (Но не показывает те категории, где нет товаров и где они не оценены). 
Иерархический список категорий следующий: 
ИД категории
ИД родительской категории
Название
...
Название
Флаг, который показывает является ли узел листом */
create or replace procedure get_info_tree_cat_goods
is
  type t_id_cat is table of integer index by pls_integer;
